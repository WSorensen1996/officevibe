...
//   - log:      window.cth.projectLog(200)   (we read kind:'message' entries)
//   - memories: window.cth.projectMemory(id) per agent (only when topics are on)
...
/** Minimal shapes we depend on (kept loose — projectLog is loosely typed). */
