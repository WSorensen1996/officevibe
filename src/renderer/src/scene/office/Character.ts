...
export class Character {
  ...
  // The pulsing accent halo marks the ONE selected agent (driven by the store's
  // selectedId), independent of what the agent is doing.
  ...
  /** Toggle the selection halo — marks the one selected agent, independent of
   *  work state. Driven by the store's selectedId. */
